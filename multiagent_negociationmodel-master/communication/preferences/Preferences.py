...
class Preferences:
    ...
    def most_preferred(self, item_list):
        ...
        for item in item_list:
            ...
            elif item_score == best_score:
                best_items.append(item)

        best_item = rd.choice(best_items)
    ...
    def is_item_among_top_10_percent(self, item, item_list):
        ...
        nb_other_items = len(item_list)-1
        preferred_to = 0
        for other_item in item_list:
            if self.is_preferred_item(item, other_item):
                preferred_to = preferred_to+1
        
        is_top_item = ((preferred_to/nb_other_items)>0.1)
